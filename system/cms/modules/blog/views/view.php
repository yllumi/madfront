...
<div class="post">
	...
	<div class="meta">
		...
		<div class="category">
			...
			<span><a href="{{ url:site }}{{ settings:blog_caption }}/category/{{ category:slug }}">{{ category:title }}</a></span>
		</div>
		{{ endif }}
		...
		<div class="keywords">
			{{ keywords }}
				<span><a href="{{ url:site }}{{ settings:blog_caption }}/tagged/{{ keyword }}">{{ keyword }}</a></span>
			{{ /keywords }}
		</div>
		{{ endif }}
